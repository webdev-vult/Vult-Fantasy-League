    ...
    <form action={formAction} className="space-y-8">
      ...
      {!registrationOpen ? (
        <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-4 text-sm leading-6 text-amber-800">
          Registration is not currently open. You can review the required information now, but the form will remain disabled until Vult opens the season.
        </div>
      ) : null}
      ...
      <section className="border-t border-[var(--border)] pt-8">
        <p className="text-xs font-black uppercase tracking-[0.18em] text-[var(--brand)]">Contact details</p>
      ...
      <section className="border-t border-[var(--border)] pt-8">
        <p className="text-xs font-black uppercase tracking-[0.18em] text-[var(--brand)]">Official FPL team</p>
        <h2 className="mt-2 text-2xl font-black text-[var(--brand-strong)]">Match your Vult league entry</h2>
        <div className="mt-4 rounded-2xl border border-blue-200 bg-blue-50 p-4 text-sm leading-6 text-blue-900">
          Join the official Vult FPL league first, then enter the <strong>Team name</strong> and <strong>Manager name</strong> exactly as they appear under New entries or Standings.
        ...
        <div className="mt-5 grid gap-5 md:grid-cols-2">
          <label className="text-sm font-bold text-[var(--brand-strong)]">
            ...
            <input className={inputClass} name="team_name" required minLength={2} maxLength={120} disabled={disabled} placeholder="Aluta - Continua FC" />
          ...
          <label className="text-sm font-bold text-[var(--brand-strong)]">
            ...
            <input className={inputClass} name="manager_name" required minLength={3} maxLength={120} disabled={disabled} placeholder="Mohamed Adams Sesay" />
